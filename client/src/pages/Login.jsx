...
export default function Login() {
  ...
  return (
    <div className="px-[16px] md:px-[40px] max-w-md mx-auto py-24">
      <h1 className="font-headline-lg text-[32px] leading-[40px] text-primary mb-8 text-center">Connexion</h1>
      ...
      <a
        ...
        className="w-full flex items-center justify-center gap-3 border border-outline rounded-lg py-3 hover:bg-surface-container-low transition-colors font-body-md text-[14px] text-on-surface"
      >
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-[12px]">
          <span className="bg-surface px-3 text-on-surface-variant font-label-sm">ou</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="mt-2 text-right">
            <Link to="/forgot-password" className="font-label-sm text-secondary hover:underline">
              Mot de passe oublié ?
            </Link>
          </div>
        </div>
      ...
      <p className="mt-8 text-center font-body-md text-[14px] leading-[20px] text-on-surface-variant">
        ...
        <Link to="/register" className="text-secondary hover:underline">Créer un compte</Link>
      </p>
    </div>
  );
}
